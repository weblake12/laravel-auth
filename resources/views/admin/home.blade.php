...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
            ...
            <nav class="navbar navbar-light bg-light">
                ...
                <div class="form-inline">
                    <form id="logout" method="post" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="btn btn-sm btn-outline-dark">@lang('Logout')</button>
                    </form>
                </div>
            </nav>
        </header>
        <main class="px-5">
            <div class="mt-5 pt-5">
                <div class="mt-5 pt-5">
                    <div class="text-center h3 mt-5 font-weight-bold">{{ config('app.name') }}</div>
                    <p class="text-center"><small>@lang('Auth page')</small></p>
                </div>
            </div>
        </main>
        <script src="https://cdn.jsdelivr.net/npm/jquery@3.5.1/dist/jquery.min.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script><script src="{{ asset('assets/plugins/cute-alert/cute-alert.js') }}"></script>
